# Contributing to Minions Test-scenarios

Thank you for your interest in contributing to Minions Test-scenarios!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-test-scenarios.git`
