...
/**
 * @minions-test-scenarios/cli — CLI for Minions Test-scenarios
 *
...
import { customTypes } from '@minions-test-scenarios/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Test-scenarios'));
        console.log(chalk.dim('Conversation scripts, tester personas, edge cases, and golden datasets'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-test-scenarios/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-test-scenarios/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-test-scenarios')}`);
